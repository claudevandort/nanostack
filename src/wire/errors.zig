...
pub const Code = enum {
    ...
    pub fn defaultMessage(self: Code) []const u8 {
        return switch (self) {
            ...
            .x_amz_content_sha256_mismatch => "The provided 'x-amz-content-sha256' header does not match what was computed.",
    ...
    pub fn httpStatus(self: Code) u16 {
        return switch (self) {
            ...
            .invalid_request, .invalid_argument, .invalid_bucket_name, .missing_content_length, .bad_request, .bad_digest, .x_amz_content_sha256_mismatch => 400,
            .invalid_range => 416,
