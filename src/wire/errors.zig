...
pub const Code = enum {
    ...
    pub fn httpStatus(self: Code) u16 {
        return switch (self) {
            ...
            .bucket_already_exists, .bucket_already_owned_by_you => 409,
            .access_denied, .signature_does_not_match, .invalid_access_key_id => 403,
            .invalid_request, .invalid_argument, .missing_content_length, .bad_request => 400,
