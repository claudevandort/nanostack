...
pub fn mapStorageErr(e: storage.Error) errors.Code {
    return switch (e) {
        ...
        storage.Error.QueueNotFound,
        storage.Error.QueueAlreadyExists,
        storage.Error.InvalidQueueName,
        storage.Error.InvalidReceiptHandle,
        storage.Error.MessageNotFound,
        storage.Error.InvalidMessageBody,
